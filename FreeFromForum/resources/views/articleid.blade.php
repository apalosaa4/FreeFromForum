...
@section('content')
    <div class="grid md:grid-cols-7 text-green-900">    
        ...
        <main class="id-main"> 
            <header>
                <h1 id="title" class="py-3 text-5xl text-justify cursor-default">{{$article->article_name}}</h2>
            </header>
            ...
            <div class="my-5">
                <div class="rounded overflow-hidden shadow-md relative transition ease-out duration-300">
                    <div class="flex justify-center">
                        <img id="image" src={{$article->article_path}} alt="noimg" class="w-full h-72 object-cover">         
                    </div>
                </div>
            </div>
            <div id="text" class="py-10 text-lg cursor-default text-justify">
